...
# reply
#gnome-terminal --title="inference" -x $shell_type -i -c "cd ${workspace}; cd ../act; source /opt/ros/jazzy/setup.bash; source /home/arx/endlessAI/repos/ARX_X5/ROS2/X5_ws/install/setup.bash; source ./.venv_ros/bin/activate; python reply.py; $shell_exec"
