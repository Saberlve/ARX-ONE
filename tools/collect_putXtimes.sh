...
# Collect for putXtimes project
launch_terminal "collect_putXtimes" "cd '${REPO_ROOT}/act' && source /opt/ros/humble/setup.bash && source '${ROS2_ROOT}/install/setup.bash' && source ./.venv_ros/bin/activate && python collect.py --datasets putXtimes --episode_idx -1"