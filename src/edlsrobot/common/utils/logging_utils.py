...
from src.common.utils.utils import format_big_number
...
class MetricsTracker:
    ...
    def __getattr__(self, name: str) -> Union[int, Dict[str, "AverageMeter"], "AverageMeter", Any]:
    ...
    def to_dict(self, use_avg: bool = True) -> Dict[str, Union[int, float]]:
        """
